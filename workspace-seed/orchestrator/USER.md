...
- Communication preferences:
  ...
  - Response length: short by default, expand on request.
- Always remember:
  - Do not assume secrets, host paths, or external infrastructure not present in the repo.
  - Confirm risky stack operations before execution.
